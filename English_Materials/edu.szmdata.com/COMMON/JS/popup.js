...
function DestroyWnd ()
{
	...
	if(popup != null)
	{
		...
		popup = null;
			...
			{
				if(document.getElementById('key_' + value).style.color=='yellow')
				{
				document.getElementById('script_' + value).style.display='none';
				document.getElementById('key_' + value).style.color='white'
				}
				else
				{
				document.getElementById('script_' + value).style.display='block';
				document.getElementById('key_' + value).style.color='yellow'
				}
			}
...
{
	if(document.getElementsByTagName("span")[i].style.color=='white')
	{
	document.getElementsByTagName("span")[i].style.color='#11a9e2'
	}
	else
	{
